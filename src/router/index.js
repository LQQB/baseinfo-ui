...
function addDynamicMenuAndRoutes(userName, to, from) {
  ...
  .then(res => {
    ...
    api.user.findPermissions({'name':userName}).then(res => {
      ...
      res.data.push('sys:testbatch:testuser:related')
      res.data.push('sys:testbatch:testsubject:unrelated')
      res.data.push('sys:testbatch:testuser:unrelated')
      res.data.push('sys:testbatch:grademodel:download')
